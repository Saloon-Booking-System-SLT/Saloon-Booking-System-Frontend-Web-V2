      ...
      <div className="main-content">
        <header className="service-header flex flex-col md:flex-row justify-between items-start md:items-center p-4 md:p-6 bg-white rounded-lg shadow-sm mb-6">
          <div className="header-content mb-4 md:mb-0">
            <h1 className="header-title text-xl md:text-2xl font-bold text-gray-800">
              Services
            </h1>
          </div>
          <div className="header-actions w-full md:w-auto">
            <button
              className="add-btn w-full md:w-auto bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
              onClick={() => {
                resetForm();
                setShowPopup(true);
              }}
        ...
        <div className="services-body flex flex-col lg:flex-row gap-6 px-4 md:px-6">
          <div className="category-panel lg:w-1/4 bg-white rounded-lg p-4 shadow-sm">
            <h3 className="category-title text-lg font-semibold mb-4">
              Categories
            </h3>
            ...
            <div className="category-link text-blue-600 cursor-pointer hover:text-blue-800 text-sm">
              Add Category
            </div>
          </div>
          ...
          <div className="service-panel flex-1">
            ...
            <div className="service-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              {loading ? (
                <div className="service-card bg-white p-4 rounded shadow-sm">
                  Loading services...
                </div>
              ) : services.length === 0 ? (
                <div className="service-card bg-white p-4 rounded shadow-sm">
                ...
                services.map((service) => (
                  <div
                    key={service._id}
                    className="service-card bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden"
                  >
                    <img
                      src={
                        service.image
                    ...
                    <div className="p-4">
                      ...
                      <div className="service-price flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <i
                            className="fas fa-edit edit-icon text-blue-600 hover:text-blue-800 cursor-pointer text-sm"
                            onClick={() => handleEdit(service)}
                          ></i>
                          <i
                            className="fas fa-trash delete-icon text-red-600 hover:text-red-800 cursor-pointer text-sm"
