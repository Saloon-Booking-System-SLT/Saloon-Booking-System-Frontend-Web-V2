...
const ReportsPage = () => {
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      const appointmentsRes = await axios.get(`${process.env.REACT_APP_API_URL}/appointments/salon/${salonData.id}`);
      const appointments = appointmentsRes.data;
      
      // Fetch services data
      const servicesRes = await axios.get(`${process.env.REACT_APP_API_URL}/services/salon/${salonData.id}`);
      // const services = servicesRes.data; // Commented out unused variable
      
      // Fetch professionals data
      const professionalsRes = await axios.get(`${process.env.REACT_APP_API_URL}/professionals/salon/${salonData.id}`);
