...
const ReportsPage = () => {
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      // Fetch services data
      const servicesRes = await axios.get(`https://dpdlab1.slt.lk:8447/salon-api/api/services/salon/${salonData.id}`);
      // const services = servicesRes.data; // Commented out unused variable
      
      // Fetch professionals data
      const professionalsRes = await axios.get(`https://dpdlab1.slt.lk:8447/salon-api/api/professionals/salon/${salonData.id}`);
